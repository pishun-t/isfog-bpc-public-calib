...
st.set_page_config(
    page_title="GEOLAB Blind Prediction Contest - IC-MAGE-M02 Calibration",
    page_icon=":bar_chart:", # bar chart emoji
)

st.markdown(
    """
    # Welcome to GEOLAB Blind Prediction Contest winner calibration web-app (ISFOG 2025 version)
    """
)
...
st.markdown(
    """
    Have a go at calibrating the constitutive model used in the winning method
    from the TU Darmstadt blind prediction contest
    for laterally loaded (monotonic and cyclic) piles in sand.
    ...
    The app is split into take you through the calibration of parameters from
